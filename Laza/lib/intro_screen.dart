                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Column(
                          children: [
                            Text('Look Good, Feel Good', style: context.headlineMedium),
                      ...
                      // FIX: Row dibungkus Flexible + width dikurangi
                      Flexible(
                        child: Column(
                          children: [
                            Row(
                              ...
                              children: [
                                Expanded(  // FIX 1: Expanded untuk Men
                                  child: InkWell(
                                    onTap: () {
                                      setState(() {
                                        isMale = true;
                                ...
                                const SizedBox(width: 10),  // FIX 3: Spacing antar button
                                Expanded(  // FIX 1: Expanded untuk Women
                                  child: InkWell(
                                    onTap: () {
                                      setState(() {
                                        isMale = false;
